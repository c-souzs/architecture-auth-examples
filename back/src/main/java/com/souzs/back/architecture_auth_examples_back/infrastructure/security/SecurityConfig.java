...
import com.souzs.back.architecture_auth_examples_back.infrastructure.exception.ErrorResponse;
...
public class SecurityConfig {
    ...
    private AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, ex) ->
                writeError(response, request.getRequestURI(), HttpServletResponse.SC_UNAUTHORIZED, "Unauthorized", "Não autenticado");
    }

    private AccessDeniedHandler accessDeniedHandler() {
        return (request, response, ex) ->
                writeError(response, request.getRequestURI(), HttpServletResponse.SC_FORBIDDEN, "Forbidden", "Acesso negado");
    }
